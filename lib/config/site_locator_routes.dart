class SiteLocatorRoutes {
  ...
  static const discountAmountPage = '/discountAmountPage';
  static const extendedNetworkFeesPage = '/extendedNetworkFeesPage';
  static const enhancedFilterPage = '/enhancedFilterPage';
